...
def gen_run_folder(path_model_id=''):
    ...
    run_paths['path_summary_train'] = os.path.join(run_paths['path_model_id'], 'summary')
    run_paths['path_summary_eval'] = os.path.join(run_paths['path_model_id'], 'summary', 'eval')
    run_paths['path_summary_image'] = os.path.join(run_paths['path_model_id'], 'summary', 'image')
